...
public class SendingParcels {
    private Long parcelId;
    private String users;
    private String senderOffice;
    private String receiverOffice;
    ...
    public String getSenderOffice() {
        return senderOffice;
    }

    public void setSenderOffice(String senderOffice) {
        this.senderOffice = senderOffice;
    }

    public String getReceiverOffice() {
        return receiverOffice;
    }

    public void setReceiverOffice(String receiverOffice) {
